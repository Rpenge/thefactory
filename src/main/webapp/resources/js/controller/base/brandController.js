//코드 리스트
app.controller('brandController', ['$scope', '$http', '$location', '$rootScope', '$window', '$filter', '$uibModal',
	function ($scope, $http, $location, $rootScope, $window, $filter, $uibModal) {

		pageInfo($rootScope, $location); //현재페이지 정보
		httpGetList($http, $scope,'/base/brandList' ); //코드리스트 조회
		...
		$scope.goPage = function(page){
			...
			httpGetList($http, $scope,'/base/brandList', param );
		};
		//페이지 사이즈 변경
