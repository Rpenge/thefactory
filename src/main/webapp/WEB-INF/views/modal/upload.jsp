		...
		<div class="modal-body" style="width: 100%;height: 280px;">
			...
			<div class="d-flex flex-column" style="margin-top:20px;">
				...
				<form method="post" id="appForm" action="upload" enctype="multipart/form-data" onsubmit="return false" >
					...
					<div class="input-group btn" style="min-width:280px;margin:0px;padding:0!important;height:40px;">
						<input ng-model="file_path" style=";border: 1px solid lightgray;width: 200px;background: white;border-radius: 5px 0 0 5px;" disabled=disabled">
				...
				<div class="d-flex" style="margin-top: 8px;">
					...
					<input type="text" class="form-control" ng-model="input.version" placeholder="version" style="width:120px;">
