...
<div class="starter-template" ng-show="authenticated">
	<div class="container-fluid body-custom">
		<div class="body-contents ">
			<h2><a class="menuName" href="" ng-click="reload()">자산 정보 관리</a></h2>
        	...
        	<div class="btnBox d-flex justify-content-between">
	        	...
	        	<div>
					<button class="btn btn-success" ng-click="assetReg()">자산 등록</button>
					<button class="btn btn-success" ng-click="modalOpen('repair')">수리 등록</button>
					<button class="btn btn-danger" ng-click="assetUpdate('DEL')">삭제</button>
				</div>
        	</div>
			<!-- 테이블 생성 -->
			<div class="table-box">
			...
			<!-- 네비게이션 바 -->
				...
				<div>
					<button class="btn btn-primary" ng-click="formDown()"><i class="xi-file-download-o"></i> 양식</button>
					<button class="btn btn-success" ng-click="excelClick()"><i class="xi-file-upload-o"></i> EXCEL업로드</button>
