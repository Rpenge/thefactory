...
<div class="starter-template" ng-show="authenticated">
	<div class="container-fluid body-custom">
		<div class="body-contents ">
			<h2><a class="menuName" href="" ng-click="reload()">자산 정보 인쇄</a></h2>
        	...
        	<!-- <table class="table-div-10 table-bordered text-center col-12"> -->
				...
				<tbody>
					...
					<tr>
						<td class="table-content" colspan="2" rowspan="2">조건 분류</td>
						<td class="table-content" colspan="2">자산</td>
						...
						<td class="table-content" colspan="2">위치</td>
						<td class="reg-form-td" colspan="2">
					...
					<tr>
						<td class="table-content" colspan="2">부서</td>
						...
						<td class="table-content" colspan="2">상태</td>
					    <td class="reg-form-td" colspan="2" style="margin:0;padding:0;">
					    	<select class="form-control fit" ng-model="search.dept" >
        	...
        	<div class="btnBox d-flex justify-content-between">
	        	...
	        	<div>
	        		<button class="btn btn-success" ng-click="excelDownAll('asset')"><i class="xi-file-download-o"></i> excel all</button>
	        		<button class="btn btn-success" ng-click="excelDown()"><i class="xi-file-download-o"></i> excel</button>
	        		<button class="btn btn-primary" ng-click="modalOpen('print')">인쇄</button>
	        		<button class="btn btn-primary" ng-click="modalOpen('QR')">QR코드 인쇄</button>
				</div>
        	</div>
			<!-- 테이블 생성 -->
			<div class="table-box">
			<table class="table custom-table-1 table-hover text-center custom-align-middle" id="tableData" style="min-width:1100px;">
				<thead>
					<tr class="pointer">
