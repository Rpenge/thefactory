...
app.config(function($routeProvider, $httpProvider, $locationProvider, $provide) {
  ...
  // .when('/member/login', {templateUrl: '/member/login', controller:
  // 'loginController'})
//  .when('/member/appDown', {
//    templateUrl : '/member/appDown',
//    controller : 'appController'
//  })
  // .when({redirectTo: '/member/appDown', templateUrl: '/member/appDown',
  // controller: 'appController' })
  .when('/system/user', {
    templateUrl : '/system/user',
...
//  })
//  .when('/inout/ioInfo', {
//    templateUrl : '/inout/ioInfo',
//    controller : 'ioInfoController',
//    resolve : {
//      auth : onlyLoggedIn,
//      layout : pageCheck
//    }
...
//    }
//  }).when('/inven/invInfo', {
//    templateUrl : '/inven/invInfo',
//    controller : 'invInfoController',
//    resolve : {
//      auth : onlyLoggedIn,
//      layout : pageCheck
//    }
//  }).when('/stock/stk', {
//    templateUrl : '/stock/stk',
...
//    }
//  }).when('/stock/stkTag', {
//    templateUrl : '/stock/stkTag',
//    controller : 'stkTagController',
//    resolve : {
//      auth : onlyLoggedIn,
//      layout : pageCheck
//    }
//  }).when('/assetManagement/assetList', {
//    templateUrl : '/assetManagement/assetList',
//    controller : 'assetMgListController',
//    resolve : {
//      auth : onlyLoggedIn,
//      layout : pageCheck
//    }
//  }).when('/ex/stk', {
//    templateUrl : '/ex/stk',
//    controller : 'stock01Controller',
//    resolve : {
//      auth : onlyLoggedIn,
//      layout : pageCheck
//    }
//})
  //기본 페이지를 otherwise로 하게 설정
.otherwise({
    redirectTo : '/member/login',
    templateUrl : '/member/login',
