...
<div class="starter-template" ng-show="authenticated">
	<div class="container-fluid body-custom">
		<div class="body-contents ">
			<h2><a class="menuName" href="" ng-click="reload()">자산 상태 변경</a></h2>
			...
			<form class="form-inline" ng-submit="clickSearch()">
				<div class="form-group search-box">
			    	...
			    	<select class="custom-select" ng-model="search.mappingYn" >
			    		<option value="">태그발행</option>
        	...
        	<div class="btnBox d-flex justify-content-between">
	        	...
	        	<div>
		        	<button class="btn btn-success right" ng-click="assetUpdate('TagN')">태그미발행</button>
		        	<button class="btn btn-success right" ng-click="assetUpdate('TagY')">태그발행</button>
		        	<button class="btn btn-primary right" ng-click="assetUpdate('DIS')">폐기</button>	
		        	<button class="btn btn-primary right" ng-click="assetUpdate('RET')">대여</button>
	        		<button class="btn btn-primary right" ng-click="assetUpdate('REP')">수리</button>
		        	<button class="btn btn-primary right" ng-click="assetUpdate('USE')" >사용</button>
	        	</div>
        	</div>
			<!-- 테이블 생성 -->
			...
			<table class="table table-striped-odd table-hover text-center custom-align-middle" style="min-width:1100px;">
				<thead>
					<tr class="pointer">
						...
						<th ng-click="sort('mappingYn')">태그발행</th>
