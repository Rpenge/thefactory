...
<div class="starter-template" ng-show="authenticated">
	...
	<div class="container-fluid body-custom">
		<div class="body-contents">
			<h2><a class="menuName" href="" ng-click="reload()">RFID 이동</a></h2>
			...
			<!-- 테이블 생성 -->
			<div class="table-box">
			<table class="table table-hover table-striped-odd text-center custom-align-middle" style="min-width:1100px;">
				<thead>
					<tr class="pointer">
