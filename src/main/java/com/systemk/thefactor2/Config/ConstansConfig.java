...
public class ConstansConfig {
	...
	public final static String VERSION_OK_MSG = "버전 검증이 성공하였습니다.";

	public final static String NOT_FIND_BARCODE_MSG = "바코드 정보를 찾을 수 없습니다.";

	public final static String NOT_FIND_RFID_TAG_MSG = "태그 정보를 찾을 수 없습니다.";

	public final static String NOT_ENOUGH_STOCK_AMOUNT_MSG = "재고가 충분하지 않습니다.";

	public final static String NOT_VALID_BARCODE_MSG = "검증되지 않은 바코드입니다.";

	public final static String ONLY_FROM_POSSIBLE_BARCODE_MSG = "오직 입고 상태인 바코드만 가능합니다.";

	public final static String ONLY_TO_POSSIBLE_BARCODE_MSG = "오직 출고 상태인 바코드만 가능합니다.";

	public final static String DUPLICATION_BARCODE_MSG = "중복된 바코드입니다.";

	public final static String NOT_FIND_FROM_MSG = "출발지 정보를 찾을 수 없습니다.";

	public final static String NOT_FIND_TO_MSG = "도착지 정보를 찾을 수 없습니다.";

	public final static String COMPLETE_BARCODE_MSG = "이미 완료된 바코드입니다.";

	public final static String DISUSE_BARCODE_MSG = "이미 사용중지된 바코드입니다.";

	public final static String MAPPING_BARCODE_MSG = "이미 맵핑된 바코드입니다.";

	public final static String EQAUL_COMPANY_POSSIBLE_BARCODE_MSG = "오직 동일한 회사의 바코드만 가능합니다.";

	public final static String ONLY_STOCK_POSSIBLE_TAG_MSG = "오직 입고 상태인 태그만 가능합니다.";

	public final static String INCLUDE_DISUSE_TAG_MSG = "폐기, 재발행 요청된 태그가 포함되어 있습니다.";

	public final static String NOT_VALID_RFID_TAG_MSG = "입고 예정 상태가 아닌 태그가 있습니다.";

	public final static String DISUSE_TAG_MSG = "폐기된 태그입니다.";

	public final static String ONLY_MAPPING_BARCODE_MSG = "오직 맵핑된 바코드만 가능합니다.";

	public final static String CONFIRM_BARCODE_MSG = "이미 확정된 바코드입니다.";

	public final static String NOT_FIND_COMPANY_MSG = "업체 정보를 찾을 수 없습니다.";

	public final static String DUPLICATION_TAG_MSG = "중복된 태그가 있습니다.";

	public final static String NOT_FIND_REISSUE_TAG_REQEUST_MSG = "태그 재발행 요청 정보가 없습니다.";

	public final static String CONFIRM_REISSUE_TAG_REQUEST_MSG = "이미 확정된 태그 재발행 요청 정보입니다.";

	public final static String COMPLETE_REISSUE_TAG_REQUEST_MSG = "이미 재발행 완료된 태그 재발행 요청 정보입니다.";

	public final static String NOT_VALID_TAG_BARCODE_MSG = "유효하지 않은 태그 바코드입니다.";

	public final static String NOT_VALID_TAG_FORCE_MSG = "유효하지 않은 태그 수기 정보 입니다.";

	public final static String NOT_VALID_STORAGE_REQUEST_TAG_MSG = "요청 태그 중에 입고할 수 없는 태그가 있습니다.";

	public final static String NOT_VALID_RELEASE_REQUEST_TAG_MSG = "요청 태그 중에 출고할 수 없는 태그가 있습니다.";

	public final static String ROLE_VIOLATION_MSG = "해당 사용자는 이 앱을 사용 할 수 없습니다.";

	public final static String CONFIRM_ORDER_MSG = "확정된 요청입니다.";

	public final static String COMPLETE_ORDER_MSG = "완료된 요청입니다.";

	public final static String NOT_FIND_STORE_MOVE_REQUEST_MSG = "매장간 이동 요청 정보를 찾을 수 없습니다.";

	public final static String CONFIRM_STORE_MOVE_REQUEST_MSG = "이미 확정된 매장간 이동 요청 정보입니다.";

	public final static String NOT_WORK_START_STORE_MOVE_REQUEST_MSG = "보내는 매장에서 아직 작업하지 않은 매장간 이동 작업입니다.";

	public final static String NOT_CONFIRM_START_STORE_MOVE_REQUEST_MSG = "보내는 매장에서 아직 확정하지 않은 매장간 이동 작업입니다.";

	public final static String NOT_WORK_END_STORE_MOVE_REQUEST_MSG = "받는 매장에서 아직 작업하지 않은 매장간 이동 작업입니다.";

	public final static String NOT_CONFIRM_END_STORE_MOVE_REQUEST_MSG = "받는 매장에서 아직 확정하지 않은 않은 매장간 이동 작업입니다.";

	public final static String COMPLETE_WORK_START_STORE_MOVE_REQUEST_MSG = "보내는 매장에서 작업 완료된 매장간 이동 작업입니다.";

	public final static String COMPLETE_CONFIRM_START_STORE_MOVE_REQUEST_MSG = "보내는 매장에서 확정된 매장간 이동 작업입니다.";

	public final static String COMPLETE_WORK_END_STORE_MOVE_REQUEST_MSG = "받는 매장에서 작업 완료된 매장간 이동 작업입니다.";

	public final static String COMPLETE_CONFIRM_END_STORE_MOVE_REQUEST_MSG = "받는 매장에서 확정된 매장간 이동 작업입니다.";

	public final static String DISUSE_STORE_MOVE_REQUEST_MSG = "완료 처리된 매장간 이동 작업입니다.";

	public final static String NOT_FIND_INVENTORY_SCHEDULE_MSG = "재고 실사 정보를 찾을 수 없습니다.";

	public final static String NOT_WORK_INVENTORY_SCHEDULE_MSG = "작업 안된 재고 실사 정보입니다.";

	public final static String CONFIRM_INVENTORY_SCHEDULE_MSG = "확정된 재고 실사 정보입니다.";

	public final static String DISUSE_INVENTORY_SCHEDULE_MSG = "완료된 재고 실사 정보입니다.";

	public final static String ANOTHER_WORK_INVENTORY_SCHEDULE_MSG = "다른 PDA에서 작업한 내역이 있습니다.";

	public final static String NOT_WORK_SAME_INVENTORY_SCHEDULE_MSG = "작업 안된 재고 실사 정보에 초기화 작업을 전송할 수 없습니다.";

	public final static String NOT_APPLY_RFID_TAG_IN_COMPANY_MSG = "이 태그는 해당 업체에서 사용할 수 없습니다.";

	public final static String NOT_FIND_STORE_BARTAG_MSG = "매장 스타일 정보를 찾을 수 없습니다.";

	public final static String FIND_NOT_CONFIRM_INVENTORY_SCHEDULE_MSG = "확정되지 않은 재고 조사 정보가 있습니다.";
	...
	public final static String NOT_COMPLETE_BOX_MSG = "완료되지 않은 박스입니다.";

	public final static String NOT_FIND_APP_MSG = "해당 앱을 찾을 수 없습니다.";

	public final static String VALID_WMS_BARCODE_MSG = "이미 검증된 바코드입니다.";

	public final static String NOT_VALID_WMS_BARCODE_MSG = "검증되지 않은 바코드입니다.";

	public final static String COMPLETE_WMS_BARCODE_MSG = "이미 완료된 바코드입니다.";

	public final static String CONVEYOR_NOT_ALL_TAG_READ_MSG = "전부 읽지 못했습니다.";

	public final static String CONVEYOR_NOT_VALID_TAG_READ_MSG = "잘못 읽힌 태그가 있습니다.";

	public final static String CONVEYOR_NOT_VALID_STYLE_AMOUNT_MSG = "스타일 별 수량이 맞지 않습니다.";

	public final static String CONVEYOR_NOT_VALID_STORAGE_BARCODE_MSG = "입고 대상 바코드가 아닙니다.";

	public final static String CONVEYOR_NOT_VALID_RELEASE_BARCODE_MSG = "출고 대상 바코드가 아닙니다.";

	public final static String CONVEYOR_CANCEL_EXCEPTION_STORAGE_MSG = "해외 입고 작업을 취소했습니다.";

	public final static String STORE_PDA_RETURN_WORKED_BOXNUM_MSG = "이미 작업에 사용된 박스 번호입니다.";

	public final static String STORE_PDA_RETURN_COMPLETED_WORK_MSG = "이미 반품 확정된 작업입니다";
