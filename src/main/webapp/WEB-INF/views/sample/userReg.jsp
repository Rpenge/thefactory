...
<div class="modal-body" ng-show="authenticated">
		<h4 style="font-weight: bold;">사용자 등록</h4>
		<div>
...
<%--								</li>--%>
					...
					<tr>
						<td class="table-content" colspan="2">ID</td>
			...
			<div class="d-flex justify-content-end">
				<button class="btn btn-outline-secondary right-bottom-btn" ng-click="upload()">저장</button>
				<button class="btn btn-secondary right-bottom-btn" ng-click="close()">닫기</button>
			</div>
		</div>
</div>
</html>
