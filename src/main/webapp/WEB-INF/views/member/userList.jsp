...
<div class="starter-template" ng-show="authenticated">
	<section class="container-fluid d-flex justify-content-between" style="width:90%;border-bottom:1px solid lightgray;">
		<div class="d-flex align-items-end">
			<h4><a class="menuName" href="" ng-click="reload()">User</a></h4>
			<h6 style="color:gray;">사용자정보</h6>
		</div>
		<ol class="breadcrumb" style="height:20px; background-color:transparent;">
			<li><a href="#">sss</a></li> &nbsp;>&nbsp;
			<li><a href="#">bbb</a></li>
		</ol>
	</section>
